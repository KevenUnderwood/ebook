    ...
    <transition name="slide-up">
        ...
        ifSettingShow || !ifTitleAndMenuShow}" v-show="ifTitleAndMenuShow" >
            <div class="icon-wrapper">
                <span class="icon-books" @click="toggleSetting(3)"></span>
            </div>
            <div class="icon-wrapper">
                <span class="icon-radio-checked" @click="toggleSetting(2)"></span>
            </div>
            <div class="icon-wrapper">
                <span class="icon-sun" @click="toggleSetting(1)"></span>
            </div>
